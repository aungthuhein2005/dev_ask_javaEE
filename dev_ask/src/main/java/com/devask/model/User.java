...
public class User {
	...
	public User(int userId,String username, String email, int reputation) {
		super();
		this.user_id = userId;
		this.username = username;
		this.email = email;
	...
	public User(int user_id, String username,boolean privateProfile, int reputation,String about,String dob, HashMap<String, String> socialList) {
		super();
		this.user_id = user_id;
		this.username = username;
		this.reputation = reputation;
	...
	public User(int userId, String username,boolean privateProfile,String about,String dob) {
		super();
		this.user_id = userId;
		this.username = username;
		this.about = about;
