...
%>
	<form id="commentForm">
		<input type="hidden" name="mode" value="CREATE" /> <input
			type="hidden" data-answer-id="<%= answerId %>" id="answerId"
			name="answerId" value="<%= answerId %>" /> <label
			class="form-label text-light" for="commentContent">Comment</label>
		<div class="d-flex align-items-end">
			<textarea name="body" class="form-control text-light mt-2 me-2"
				id="commentContent"
