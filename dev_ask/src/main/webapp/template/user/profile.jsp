...
<body style="background: #171527;">
    ...
    <span style="color: #fff; font-size: 20px;">${fn:toUpperCase(fn:substring(user.username, 0, 1))}</span>
			...
			<div
				class="ps-4 d-flex align-items-end justify-content-between w-100">
				<div>
		...
		<div class="tab-content" id="nav-tabContent">
			...
			<div class="tab-pane fade show" id="nav-setting" role="tabpanel"
				...
				<div class="my-4">
					...
					<a href="user?mode=LOGOUT" class="bg-danger px-2 py-1 text-white text-decoration-none rounded">Logout</a>
				</div>
			</div>
		</div>
