			...
			<div class="col-lg-9 col-md-8 col-sm-12 border-end">
				...
				<div class="my-4">
					...
					<div class="border-top border-bottom d-flex py-2">
						<h3 class="text-success me-2">
							<i class="bi bi-check-circle-fill"></i>
						</h3>
						<div class="border-start border-5">
							<p class="ps-2">You can implement pagination in a RESTful API
								by using query parameters like `page` and `limit`. For example,
								you can use `/items?page=2&limit=50` to get the second page with
								50 items per page. Make sure to include metadata in the
								response, like the total number of items and pages.</p>
							<div class="text-end mb-2">
								<span class="me-2">45 <i
									class="bi bi-hand-thumbs-up-fill"></i></span> <span class="me-2">2
						...
						<div class="border-top border-bottom d-flex py-2">
							...
							<div class="w-100">
								...
								<div class="d-flex align-items-center justify-content-between">
									<button
										class="show-comments btn btn-sm text-secondary border-0"
										data-answer-id="${answer.answerId}">Show Comments</button>
									<div class="text-end mb-2" style="font-size: 13px;">
										<span class="me-2">${answer.commentCount }
											${answer.commentCount > 1 ? "Comments" : "Comment" } <i
											class="bi bi-chat-fill"></i>
										</span> <span>${answer.vote } ${answer.vote > 1 ? "Votes" : "Vote" }
											<i class="bi bi-star-fill"></i>
										</span>
									</div>
								</div>

								<div class="comments" id="comments-${answer.answerId}"
									style="display: none;">
